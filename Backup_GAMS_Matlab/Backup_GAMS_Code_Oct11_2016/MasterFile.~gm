...
$ontext
*Good vs Bad decision case study
Dst_full_realization(s,h,run)=0;
Dst_full_realization('M3','h8',run)=5;
Dst_full_realization('M4','h8',run)=5;
Dst_full_realization('M3','h16',run)=2.5;
Dst_full_realization('M4','h16',run)=2.5;
Dst_full_realization('M3','h24',run)=2.5;
Dst_full_realization('M4','h24',run)=2.5;
*Good vs Bad decision case study
$offtext
$ontext
*Closed-loop cost increases and then decreases with MH study
Dst_full_realization(s,h,run)=0;
Dst_full_realization(s,h,run)$(product_states(s) AND (mod(ord(h)-9,24) eq 0) AND ord(h)-1 ge 8)=5;
Dst_full_realization(s,h,run)$(product_states(s) AND (mod(ord(h)-17,24) eq 0 OR mod(ord(h)-25,24) eq 0) AND ord(h)-1 ge 16)=2.5;
*Closed-loop cost increases and then decreases with MH study
$offtext
