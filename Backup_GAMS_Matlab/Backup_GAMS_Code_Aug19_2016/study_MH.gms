...
SETS
*DESIGN PARAMETERS
MH      Moving Horizon Length           /MH1*MH9/
...
$offtext
par_DM(N,DF,DL)  /(N2,N3).DF1.(DL1 3,DL2 4,DL3 5)/;
par_DM(N,DF,DL)$(ord(N) eq 2 OR ord(N) eq 3)= par_DM(N,'DF1',DL)*(par_DF(N,DF)/par_DF(N,'DF1'));
