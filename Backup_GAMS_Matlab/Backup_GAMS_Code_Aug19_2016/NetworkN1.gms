...
*         /(Reactor1).(TA,TB),Heater.Heating/
         ...
         FIS(s) States with Finite Intermediate Storage
         product_states(s) Product States/M2/
...
Parameters rho(i,s) proportion of input of task i from states s
           ...
           /T1.U1 1/
           Cs(s) maximum storage capacity for stage s  /(M1*M2) 99999/
           Cst(s) unit price of s/M1 1, M2 10/
;
*pis(i,s)=5;
pi(i)=smax(s,pis(i,s));
