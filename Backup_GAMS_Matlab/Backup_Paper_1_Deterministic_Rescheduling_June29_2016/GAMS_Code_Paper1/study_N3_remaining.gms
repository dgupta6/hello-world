...
SETS
*DESIGN PARAMETERS
MH      Moving Horizon Length           /MH1*MH5/
...
$offtext
par_DM(N,DF,DL)  /(N3).DF1.(DL1 1,DL2 2,DL3 3)/;
...
comb(N,MH,RF,OPT)$((ord(MH) eq 1 OR ord(MH) eq 2 OR ord(MH) eq 3) AND ord(OPT) eq 1)= yes;
