*Processing times for stage 2 are doubled
*Betamax has been made half
Sets     i tasks  /T1*T7/
         s states /M1*M8/
         j units  /U1*U6/
...
Parameters rho(i,s) proportion of input of task i from states s
           ...
           /T1.M2 2,T2.M3 4, T3.M4 4, T4.M5 6, T5.M6 2, T6.M7 3, T7.M8 1/
           ...
           /T1.(U1,U2) 20, (T2,T3,T4).(U3,U4) 10, (T5*T7).(U5,U6) 10/
